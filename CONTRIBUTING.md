# Contributing to neoclippy.nvim
...
- Look at the currently open [issues](https://github.com/October-Studios/neoclippy.nvim/issues)
...
neoclippy.nvim/pulls)) to see if some abandoned PR interests you.<br>
...
- VimDocs are auto-generated with [panvimdoc](https://github.com/kdheepak/panvimdoc) from README.md.
  Do not make changes to doc/neoclippy.txt. Instead, add docs to README or Wiki.
